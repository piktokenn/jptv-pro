...
.method public constructor <init>(IIILjava/util/List;Lcom/google/android/exoplayer2/drm/ExoMediaCrypto;Z)V
    ...
    new-array v2, v2, [Lc/g/b/b/v2/f;

    move v3, p2

    new-array v3, v3, [Lcom/google/android/exoplayer2/decoder/SimpleOutputBuffer;

    invoke-direct {p0, v2, v3}, Lc/g/b/b/v2/i;-><init>([Lc/g/b/b/v2/f;[Lc/g/b/b/v2/h;)V
    ...
    :cond_0
    new-instance v0, Lc/g/b/b/y2/f/c;

    const-string v1, "Opus decoder does not support secure decode"

    invoke-direct {v0, v1}, Lc/g/b/b/y2/f/c;-><init>(Ljava/lang/String;)V
    ...
    :cond_5
    :goto_2
    invoke-static/range {p4 .. p4}, Lc/g/b/b/t2/i0;->d(Ljava/util/List;)I

    move-result v1

    iput v1, v7, Lcom/google/android/exoplayer2/ext/opus/OpusDecoder;->q:I

    invoke-static/range {p4 .. p4}, Lc/g/b/b/t2/i0;->f(Ljava/util/List;)I
    ...
    invoke-static {v0}, Lc/g/b/b/t2/i0;->c([B)I
    ...
    invoke-direct {v0, v6}, Lc/g/b/b/y2/f/c;-><init>(Ljava/lang/String;)V
...
.method public static synthetic y(Lcom/google/android/exoplayer2/ext/opus/OpusDecoder;Lc/g/b/b/v2/h;)V
    .locals 0

    invoke-virtual {p0, p1}, Lc/g/b/b/v2/i;->r(Lc/g/b/b/v2/h;)V
...
# virtual methods
.method public g()Lc/g/b/b/v2/f;
    .locals 2

    new-instance v0, Lc/g/b/b/v2/f;

    const/4 v1, 0x2

    invoke-direct {v0, v1}, Lc/g/b/b/v2/f;-><init>(I)V
...
.method public bridge synthetic i(Ljava/lang/Throwable;)Lc/g/b/b/v2/e;
    ...
    invoke-virtual {p0, p1}, Lcom/google/android/exoplayer2/ext/opus/OpusDecoder;->w(Ljava/lang/Throwable;)Lc/g/b/b/y2/f/c;
...
.method public bridge synthetic j(Lc/g/b/b/v2/f;Lc/g/b/b/v2/h;Z)Lc/g/b/b/v2/e;
    ...
    invoke-virtual {p0, p1, p2, p3}, Lcom/google/android/exoplayer2/ext/opus/OpusDecoder;->x(Lc/g/b/b/v2/f;Lcom/google/android/exoplayer2/decoder/SimpleOutputBuffer;Z)Lc/g/b/b/y2/f/c;
...
.method public v()Lcom/google/android/exoplayer2/decoder/SimpleOutputBuffer;
    ...
    new-instance v1, Lc/g/b/b/y2/f/a;

    invoke-direct {v1, p0}, Lc/g/b/b/y2/f/a;-><init>(Lcom/google/android/exoplayer2/ext/opus/OpusDecoder;)V

    invoke-direct {v0, v1}, Lcom/google/android/exoplayer2/decoder/SimpleOutputBuffer;-><init>(Lc/g/b/b/v2/h$a;)V

    return-object v0
.end method

.method public w(Ljava/lang/Throwable;)Lc/g/b/b/y2/f/c;
    .locals 2
    ...
    invoke-direct {v0, v1, p1}, Lc/g/b/b/y2/f/c;-><init>(Ljava/lang/String;Ljava/lang/Throwable;)V

    return-object v0
.end method

.method public x(Lc/g/b/b/v2/f;Lcom/google/android/exoplayer2/decoder/SimpleOutputBuffer;Z)Lc/g/b/b/y2/f/c;
    .locals 19
    ...
    iget-wide v1, v0, Lc/g/b/b/v2/f;->e:J
    ...
    :cond_1
    iget-object v1, v0, Lc/g/b/b/v2/f;->c:Ljava/nio/ByteBuffer;
    ...
    iget-object v1, v0, Lc/g/b/b/v2/f;->b:Lc/g/b/b/v2/b;

    invoke-virtual/range {p1 .. p1}, Lc/g/b/b/v2/f;->v()Z
    ...
    iget v11, v1, Lc/g/b/b/v2/b;->c:I

    iget-object v0, v1, Lc/g/b/b/v2/b;->b:[B
    ...
    iget-object v0, v1, Lc/g/b/b/v2/b;->a:[B
    ...
    iget v4, v1, Lc/g/b/b/v2/b;->f:I

    iget-object v0, v1, Lc/g/b/b/v2/b;->d:[I

    iget-object v1, v1, Lc/g/b/b/v2/b;->e:[I
    ...
    iget-wide v3, v0, Lc/g/b/b/v2/f;->e:J
    ...
    invoke-direct {v1, v2, v0}, Lc/g/b/b/x2/s;-><init>(ILjava/lang/String;)V

    new-instance v2, Lc/g/b/b/y2/f/c;

    invoke-direct {v2, v0, v1}, Lc/g/b/b/y2/f/c;-><init>(Ljava/lang/String;Ljava/lang/Throwable;)V

    return-object v2

    :cond_3
    new-instance v1, Lc/g/b/b/y2/f/c;
    ...
    invoke-direct {v1, v0}, Lc/g/b/b/y2/f/c;-><init>(Ljava/lang/String;)V
    ...
    invoke-virtual {v1, v3}, Lc/g/b/b/v2/a;->addFlag(I)V
