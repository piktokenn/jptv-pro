...
.field public final c:La/i/h/j$e;
...
# direct methods
.method public constructor <init>(La/i/h/j$e;)V
    .locals 13
    ...
    iput-object v0, p0, La/i/h/k;->f:Ljava/util/List;

    new-instance v0, Landroid/os/Bundle;

    invoke-direct {v0}, Landroid/os/Bundle;-><init>()V

    iput-object v0, p0, La/i/h/k;->g:Landroid/os/Bundle;

    iput-object p1, p0, La/i/h/k;->c:La/i/h/j$e;

    iget-object v0, p1, La/i/h/j$e;->a:Landroid/content/Context;

    iput-object v0, p0, La/i/h/k;->a:Landroid/content/Context;
    ...
    iget-object v3, p1, La/i/h/j$e;->a:Landroid/content/Context;

    if-lt v0, v1, :cond_0

    iget-object v4, p1, La/i/h/j$e;->L:Ljava/lang/String;
    ...
    :goto_0
    iput-object v2, p0, La/i/h/k;->b:Landroid/app/Notification$Builder;

    iget-object v2, p1, La/i/h/j$e;->T:Landroid/app/Notification;

    iget-object v3, p0, La/i/h/k;->b:Landroid/app/Notification$Builder;
    ...
    iget-object v5, p1, La/i/h/j$e;->i:Landroid/widget/RemoteViews;
    ...
    iget-object v4, p1, La/i/h/j$e;->e:Ljava/lang/CharSequence;

    invoke-virtual {v3, v4}, Landroid/app/Notification$Builder;->setContentTitle(Ljava/lang/CharSequence;)Landroid/app/Notification$Builder;

    move-result-object v3

    iget-object v4, p1, La/i/h/j$e;->f:Ljava/lang/CharSequence;

    invoke-virtual {v3, v4}, Landroid/app/Notification$Builder;->setContentText(Ljava/lang/CharSequence;)Landroid/app/Notification$Builder;

    move-result-object v3

    iget-object v4, p1, La/i/h/j$e;->k:Ljava/lang/CharSequence;

    invoke-virtual {v3, v4}, Landroid/app/Notification$Builder;->setContentInfo(Ljava/lang/CharSequence;)Landroid/app/Notification$Builder;

    move-result-object v3

    iget-object v4, p1, La/i/h/j$e;->g:Landroid/app/PendingIntent;
    ...
    iget-object v4, p1, La/i/h/j$e;->h:Landroid/app/PendingIntent;
    ...
    iget-object v4, p1, La/i/h/j$e;->j:Landroid/graphics/Bitmap;
    ...
    iget v4, p1, La/i/h/j$e;->l:I

    invoke-virtual {v3, v4}, Landroid/app/Notification$Builder;->setNumber(I)Landroid/app/Notification$Builder;

    move-result-object v3

    iget v4, p1, La/i/h/j$e;->u:I

    iget v9, p1, La/i/h/j$e;->v:I

    iget-boolean v10, p1, La/i/h/j$e;->w:Z
    ...
    iget-object v4, p0, La/i/h/k;->b:Landroid/app/Notification$Builder;
    ...
    iget-object v0, p0, La/i/h/k;->b:Landroid/app/Notification$Builder;

    iget-object v8, p1, La/i/h/j$e;->r:Ljava/lang/CharSequence;
    ...
    check-cast v8, La/i/h/j$a;

    invoke-virtual {p0, v8}, La/i/h/k;->b(La/i/h/j$a;)V

    goto :goto_5

    :cond_6
    iget-object v0, p1, La/i/h/j$e;->E:Landroid/os/Bundle;

    if-eqz v0, :cond_7

    iget-object v8, p0, La/i/h/k;->g:Landroid/os/Bundle;
    ...
    iget-boolean v0, p1, La/i/h/j$e;->A:Z

    if-eqz v0, :cond_8

    iget-object v0, p0, La/i/h/k;->g:Landroid/os/Bundle;
    ...
    :cond_8
    iget-object v0, p1, La/i/h/j$e;->x:Ljava/lang/String;
    ...
    iget-boolean v0, p1, La/i/h/j$e;->y:Z
    ...
    :cond_a
    iget-object v0, p1, La/i/h/j$e;->z:Ljava/lang/String;
    ...
    :cond_b
    iget-object v0, p1, La/i/h/j$e;->I:Landroid/widget/RemoteViews;

    iput-object v0, p0, La/i/h/k;->d:Landroid/widget/RemoteViews;

    iget-object v0, p1, La/i/h/j$e;->J:Landroid/widget/RemoteViews;

    iput-object v0, p0, La/i/h/k;->e:Landroid/widget/RemoteViews;
    ...
    iget-object v8, p0, La/i/h/k;->b:Landroid/app/Notification$Builder;

    iget-boolean v9, p1, La/i/h/j$e;->n:Z
    ...
    iget-object v8, p1, La/i/h/j$e;->c:Ljava/util/ArrayList;

    invoke-static {v8}, La/i/h/k;->g(Ljava/util/List;)Ljava/util/List;

    move-result-object v8

    iget-object v9, p1, La/i/h/j$e;->W:Ljava/util/ArrayList;

    invoke-static {v8, v9}, La/i/h/k;->e(Ljava/util/List;Ljava/util/List;)Ljava/util/List;
    ...
    iget-object v9, p0, La/i/h/k;->g:Landroid/os/Bundle;
    ...
    iget-object v0, p1, La/i/h/j$e;->c:Ljava/util/ArrayList;

    invoke-static {v0}, La/i/h/k;->g(Ljava/util/List;)Ljava/util/List;

    move-result-object v0

    iget-object v3, p1, La/i/h/j$e;->W:Ljava/util/ArrayList;

    invoke-static {v0, v3}, La/i/h/k;->e(Ljava/util/List;Ljava/util/List;)Ljava/util/List;
    ...
    :cond_10
    iget-object v0, p1, La/i/h/j$e;->W:Ljava/util/ArrayList;
    ...
    :cond_11
    iget-object v0, p1, La/i/h/j$e;->K:Landroid/widget/RemoteViews;

    iput-object v0, p0, La/i/h/k;->i:Landroid/widget/RemoteViews;

    iget-object v0, p1, La/i/h/j$e;->d:Ljava/util/ArrayList;
    ...
    invoke-virtual {p1}, La/i/h/j$e;->e()Landroid/os/Bundle;
    ...
    :goto_9
    iget-object v11, p1, La/i/h/j$e;->d:Ljava/util/ArrayList;
    ...
    iget-object v12, p1, La/i/h/j$e;->d:Ljava/util/ArrayList;

    invoke-virtual {v12, v10}, Ljava/util/ArrayList;->get(I)Ljava/lang/Object;

    move-result-object v12

    check-cast v12, La/i/h/j$a;

    invoke-static {v12}, La/i/h/l;->b(La/i/h/j$a;)Landroid/os/Bundle;
    ...
    iget-object v3, p1, La/i/h/j$e;->V:Landroid/graphics/drawable/Icon;
    ...
    iget-object v3, p1, La/i/h/j$e;->I:Landroid/widget/RemoteViews;
    ...
    :cond_16
    iget-object v3, p1, La/i/h/j$e;->J:Landroid/widget/RemoteViews;
    ...
    :cond_17
    iget-object v3, p1, La/i/h/j$e;->K:Landroid/widget/RemoteViews;
    ...
    check-cast v4, La/i/h/n;

    iget-object v7, p0, La/i/h/k;->b:Landroid/app/Notification$Builder;

    invoke-virtual {v4}, La/i/h/n;->h()Landroid/app/Person;
    ...
    iget-boolean v7, p1, La/i/h/j$e;->R:Z
    ...
    iget-object v7, p1, La/i/h/j$e;->S:La/i/h/j$d;

    invoke-static {v7}, La/i/h/j$d;->a(La/i/h/j$d;)Landroid/app/Notification$BubbleMetadata;
    ...
    iget-object v4, p1, La/i/h/j$e;->O:La/i/i/c;
    ...
    :cond_1d
    :goto_b
    iget-boolean p1, p1, La/i/h/j$e;->U:Z

    if-eqz p1, :cond_20

    iget-object p1, p0, La/i/h/k;->c:La/i/h/j$e;

    iget-boolean p1, p1, La/i/h/j$e;->y:Z

    if-eqz p1, :cond_1e

    iput v5, p0, La/i/h/k;->h:I

    goto :goto_c

    :cond_1e
    iput v6, p0, La/i/h/k;->h:I

    :goto_c
    iget-object p1, p0, La/i/h/k;->b:Landroid/app/Notification$Builder;
    ...
    iget-object v2, p0, La/i/h/k;->b:Landroid/app/Notification$Builder;
    ...
    iget-object p1, p1, La/i/h/j$e;->x:Ljava/lang/String;
...
.method public static g(Ljava/util/List;)Ljava/util/List;
    ...
    check-cast v1, La/i/h/n;

    invoke-virtual {v1}, La/i/h/n;->g()Ljava/lang/String;
...
.method public final b(La/i/h/j$a;)V
    .locals 5
    ...
    invoke-virtual {p1}, La/i/h/j$a;->f()Landroidx/core/graphics/drawable/IconCompat;
    ...
    :goto_0
    invoke-virtual {p1}, La/i/h/j$a;->j()Ljava/lang/CharSequence;

    move-result-object v2

    invoke-virtual {p1}, La/i/h/j$a;->a()Landroid/app/PendingIntent;
    ...
    :goto_2
    invoke-virtual {p1}, La/i/h/j$a;->g()[La/i/h/o;
    ...
    invoke-static {v1}, La/i/h/o;->b([La/i/h/o;)[Landroid/app/RemoteInput;
    ...
    :cond_3
    invoke-virtual {p1}, La/i/h/j$a;->d()Landroid/os/Bundle;
    ...
    :goto_4
    invoke-virtual {p1}, La/i/h/j$a;->b()Z
    ...
    :cond_5
    invoke-virtual {p1}, La/i/h/j$a;->h()I
    ...
    invoke-virtual {p1}, La/i/h/j$a;->k()Z
    ...
    :cond_7
    invoke-virtual {p1}, La/i/h/j$a;->i()Z
    ...
    iget-object v0, p0, La/i/h/k;->f:Ljava/util/List;

    iget-object v1, p0, La/i/h/k;->b:Landroid/app/Notification$Builder;

    invoke-static {v1, p1}, La/i/h/l;->f(Landroid/app/Notification$Builder;La/i/h/j$a;)Landroid/os/Bundle;
...
.method public c()Landroid/app/Notification;
    ...
    iget-object v0, p0, La/i/h/k;->c:La/i/h/j$e;

    iget-object v0, v0, La/i/h/j$e;->q:La/i/h/j$g;

    if-eqz v0, :cond_0

    invoke-virtual {v0, p0}, La/i/h/j$g;->b(La/i/h/i;)V

    :cond_0
    if-eqz v0, :cond_1

    invoke-virtual {v0, p0}, La/i/h/j$g;->j(La/i/h/i;)Landroid/widget/RemoteViews;
    ...
    :goto_0
    invoke-virtual {p0}, La/i/h/k;->d()Landroid/app/Notification;
    ...
    :cond_2
    iget-object v1, p0, La/i/h/k;->c:La/i/h/j$e;

    iget-object v1, v1, La/i/h/j$e;->I:Landroid/widget/RemoteViews;
    ...
    invoke-virtual {v0, p0}, La/i/h/j$g;->i(La/i/h/i;)Landroid/widget/RemoteViews;
    ...
    iget-object v4, p0, La/i/h/k;->c:La/i/h/j$e;

    iget-object v4, v4, La/i/h/j$e;->q:La/i/h/j$g;

    invoke-virtual {v4, p0}, La/i/h/j$g;->k(La/i/h/i;)Landroid/widget/RemoteViews;
    ...
    invoke-static {v2}, La/i/h/j;->a(Landroid/app/Notification;)Landroid/os/Bundle;

    move-result-object v1

    if-eqz v1, :cond_6

    invoke-virtual {v0, v1}, La/i/h/j$g;->a(Landroid/os/Bundle;)V
...
.method public d()Landroid/app/Notification;
    ...
    invoke-virtual {p0, v0}, La/i/h/k;->h(Landroid/app/Notification;)V
    ...
    iget-object v1, p0, La/i/h/k;->g:Landroid/os/Bundle;
    ...
    iget-object v1, p0, La/i/h/k;->d:Landroid/widget/RemoteViews;
    ...
    :cond_4
    iget-object v1, p0, La/i/h/k;->e:Landroid/widget/RemoteViews;
    ...
    :cond_5
    iget-object v1, p0, La/i/h/k;->i:Landroid/widget/RemoteViews;
    ...
    invoke-static {v0}, La/i/h/l;->a(Ljava/util/List;)Landroid/util/SparseArray;
    ...
    invoke-static {v0}, La/i/h/j;->a(Landroid/app/Notification;)Landroid/os/Bundle;

    move-result-object v1

    new-instance v3, Landroid/os/Bundle;

    iget-object v4, p0, La/i/h/k;->g:Landroid/os/Bundle;
    ...
    iget-object v1, p0, La/i/h/k;->f:Ljava/util/List;

    invoke-static {v1}, La/i/h/l;->a(Ljava/util/List;)Landroid/util/SparseArray;
...
.method public f()Landroid/content/Context;
    ...
    iget-object v0, p0, La/i/h/k;->a:Landroid/content/Context;
