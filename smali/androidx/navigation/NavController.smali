...
.method public final b()Z
    ...
    :cond_3
    invoke-virtual {v0}, La/v/k;->L()La/v/l;
    ...
    :cond_6
    :goto_2
    invoke-virtual {v2}, La/v/k;->L()La/v/l;
...
.method public d(I)La/v/k;
    ...
    :goto_1
    invoke-virtual {v0, p1}, La/v/l;->V(I)La/v/k;
...
.method public final e([I)Ljava/lang/String;
    ...
    :cond_0
    invoke-virtual {v0, v2}, La/v/l;->V(I)La/v/k;
    ...
    invoke-static {p1, v2}, La/v/k;->v(Landroid/content/Context;I)Ljava/lang/String;
    ...
    :goto_2
    invoke-virtual {v3}, La/v/l;->Y()I

    move-result v0

    invoke-virtual {v3, v0}, La/v/l;->V(I)La/v/k;
...
.method public m(Landroid/content/Intent;)Z
    ...
    invoke-virtual {v1, v5}, La/v/l;->M(La/v/j;)La/v/k$a;
    ...
    invoke-virtual {v1}, La/v/k$a;->h()Landroid/os/Bundle;
    ...
    invoke-static {v1}, La/i/h/q;->f(Landroid/content/Context;)La/i/h/q;

    move-result-object v1

    invoke-virtual {v1, p1}, La/i/h/q;->b(Landroid/content/Intent;)La/i/h/q;

    move-result-object p1

    invoke-virtual {p1}, La/i/h/q;->I()V
    ...
    invoke-static {v0, v1}, La/v/k;->v(Landroid/content/Context;I)Ljava/lang/String;
    ...
    :cond_e
    invoke-virtual {v1, v7}, La/v/l;->V(I)La/v/k;
    ...
    :goto_5
    invoke-virtual {v8}, La/v/l;->Y()I

    move-result v1

    invoke-virtual {v8, v1}, La/v/l;->V(I)La/v/k;
    ...
    invoke-static {v0, v7}, La/v/k;->v(Landroid/content/Context;I)Ljava/lang/String;
...
.method public q(ILandroid/os/Bundle;La/v/p;La/v/s$a;)V
    ...
    invoke-static {p2, v3}, La/v/k;->v(Landroid/content/Context;I)Ljava/lang/String;
    ...
    invoke-static {p2, p1}, La/v/k;->v(Landroid/content/Context;I)Ljava/lang/String;
...
.method public final r(La/v/k;Landroid/os/Bundle;La/v/p;La/v/s$a;)V
    ...
    invoke-virtual {p1}, La/v/k;->K()Ljava/lang/String;
    ...
    :goto_2
    invoke-virtual {v3}, La/v/k;->L()La/v/l;
    ...
    invoke-virtual {p1}, La/v/k;->L()La/v/l;
    ...
    invoke-virtual {v3, v4, v0}, La/v/l;->W(IZ)La/v/k;
...
.method public s()Z
    ...
    invoke-virtual {v3, v4}, La/v/l;->M(La/v/j;)La/v/k$a;
    ...
    invoke-virtual {v3}, La/v/k$a;->h()Landroid/os/Bundle;
    ...
    invoke-virtual {v0}, La/v/i;->a()La/i/h/q;
...
.method public final t(Landroid/os/Bundle;)V
    ...
    invoke-virtual {v6}, La/v/f;->f()Ljava/util/UUID;

    move-result-object v14

    invoke-virtual {v6}, La/v/f;->e()Landroid/os/Bundle;
    ...
    invoke-static {v1, v2}, La/v/k;->v(Landroid/content/Context;I)Ljava/lang/String;
...
.method public w(IZ)Z
    ...
    invoke-virtual {v3}, La/v/k;->K()Ljava/lang/String;
